...
/*   Updated: 2025/11/25 12:08:36 by clfouger         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_textures(t_hub *hub)
{
	...
	load_single_texture(hub, hub->mlx->floor_sprite, "textures/floor.xpm");
	load_single_texture(hub, hub->mlx->roof_sprite, "textures/roof.xpm");
